...
class InternalTenantContextAuthorizationTest extends TestCase
{
    #[Test]
    public function test_internal_route_with_required_tenant_context_fails_without_header(): void
    {
    ...
    #[Test]
    public function test_internal_route_with_header_but_without_tenant_select_permission_fails(): void
    {
    ...
    #[Test]
    public function test_internal_route_with_header_and_permission_succeeds(): void
    {
        $tenant = $this->createAccount();
    ...
    private function grantInternalPermission(string $userId, string $key, string $audience): void
    {
        ...
        DB::table('internal_roles')->insert([
            'id' => $roleId,
            'name' => 'internal_ctx_' . Str::random(8),
            'display_name' => 'Internal Context Role',
            'description' => 'Internal context role',
            'is_system' => false,
            'created_at' => now(),
            'updated_at' => now(),
            'deleted_at' => null,
