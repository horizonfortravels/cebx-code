...
class InternalExternalRoutingSmokeTest extends TestCase
{
    #[Test]
    public function test_external_user_without_account_id_is_blocked_on_tenant_context_routes(): void
    {
        $externalUserWithoutAccount = $this->createUser('external', false);

        Sanctum::actingAs($externalUserWithoutAccount);
    ...
    #[Test]
    public function test_internal_user_can_access_internal_route_without_tenant_context(): void
    {
        ...
        $response->assertOk()
            ->assertJsonPath('data.message', 'internal_route_ok');
    }
