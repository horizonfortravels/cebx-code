...
class InternalTenantContextSelectionTest extends TestCase
{
    #[Test]
    public function test_internal_tenant_context_required_route_fails_without_header(): void
    {
    ...
    #[Test]
    public function test_internal_tenant_context_required_route_fails_without_tenant_select_permission(): void
    {
    ...
    #[Test]
    public function test_internal_tenant_context_required_route_succeeds_with_tenant_select_permission(): void
    {
        $tenant = $this->createAccount();
        $internalUser = $this->createUser([
            'account_id' => null,
    ...
    private function grantInternalPermission(string $userId, string $key): void
    {
        ...
        DB::table('internal_roles')->insert([
            ...
            'display_name' => 'Internal Security Role',
            'description' => 'Internal security role',
            'is_system' => false,
            'created_at' => now(),
            'updated_at' => now(),
            'deleted_at' => null,
