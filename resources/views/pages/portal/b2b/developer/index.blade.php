...
<div style="display:grid;gap:24px">
    <section style="padding:28px;border-radius:24px;background:linear-gradient(135deg,#111827,#0f766e);color:#fff">
        ...
        <p style="margin:0;max-width:760px;line-height:1.9;color:rgba(255,255,255,.9)">
            هذه المساحة تجمع ما يحتاجه فريق تكامل المنظمة مع المنصة داخل المتصفح: حالة الربط، مفاتيح API، وإعدادات الويبهوكات.
            وإذا بقي إجراء معيّن عبر API فقط فسيظهر هنا بوضوح مع توجيه عملي. هذه المساحة لا تمنح ملكية لتكاملات الناقلين لأن تلك التكاملات تبقى مملوكة ومدارة من المنصة.
        </p>
    </section>
