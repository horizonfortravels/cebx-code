...
<div style="display:grid;gap:24px">
    <section style="padding:28px;border-radius:24px;background:linear-gradient(135deg,#111827,#0f766e);color:#fff">
        ...
        <p style="margin:0;max-width:760px;line-height:1.9;color:rgba(255,255,255,.9)">
            هذه المساحة تجمع ما يحتاجه فريق تكامل المنظمة مع المنصة داخل المتصفح: حالة الربط، مفاتيح الواجهة البرمجية، وإعدادات الويبهوكات.
            وإذا بقي إجراء معيّن عبر الواجهة البرمجية فقط فسيظهر هنا بوضوح مع توجيه عملي. هذه المساحة لا تمنح ملكية لتكاملات الناقلين لأن تلك التكاملات تبقى مملوكة ومدارة من المنصة.
        </p>
    </section>
    ...
    <section style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:18px">
        <article class="card">
            ...
            @if($recentApiKeys->isEmpty())
                <div class="empty-state">لا توجد مفاتيح برمجية حالية لهذا المستخدم. يمكنك إنشاء مفتاح جديد من صفحة المفاتيح.</div>
            @else
