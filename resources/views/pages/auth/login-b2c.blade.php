...
@section('brand-content')
    <div class="brand-logo"
        style="background:linear-gradient(135deg,#0D9488,#065F56);box-shadow:0 8px 32px rgba(13,148,136,0.4)">أفراد</div>
    ...
    <p class="brand-desc">بوابة مخصصة للحسابات الفردية الخارجية فقط، لإدارة الشحنات الشخصية عبر شبكة الناقلين التابعة
        للمنصة.</p>
...
@section('email-placeholder', 'مثال: اسم@الشخص.sa')
