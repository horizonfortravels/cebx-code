...
@section('brand-content')
    <div class="brand-logo" style="background:linear-gradient(135deg,#1E3A5F,#2D5A8E);box-shadow:0 8px 32px rgba(30,58,95,0.4)">ش</div>
    <span class="brand-badge" style="background:rgba(255,255,255,0.15);color:#BFDBFE">بوابة الشحن</span>
    <h2 class="brand-title">بوابة إدارة الشحن</h2>
    <p class="brand-desc">منصة عربية لإدارة بوابة الشحن</p>
@endsection
