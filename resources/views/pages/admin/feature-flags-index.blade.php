...
<div class="card" style="margin-bottom:24px">
    ...
    <form method="GET" action="{{ route('internal.feature-flags.index') }}" style="display:grid;grid-template-columns:2fr repeat(2,minmax(0,1fr)) auto;gap:12px;align-items:end">
        <div>
