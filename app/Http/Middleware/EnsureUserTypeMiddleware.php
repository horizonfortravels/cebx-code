    ...
    private function browserGuidance(object $user, string $expectedType): array
    {
        if ($expectedType === 'internal') {
            return [
                ...
                'message' => 'حسابك خارجي، لذلك لا يمكن فتح صفحات الإدارة الداخلية من هنا. استخدم البوابة المناسبة لنوع حسابك بينما تبقى هذه المساحة مخصصة لموظفي المنصة.',
        ...
        return [
            ...
            'message' => 'بوابات العملاء مخصصة للحسابات الخارجية فقط: B2C للحسابات الفردية وB2B لحسابات المنظمات. استخدم المساحة الداخلية للوصول إلى أدوات موظفي المنصة المناسبة لدورك.',
