...
class ProfitabilityPolicy
{
    ...
    {
        return $this->allowsTenantAction($user, 'profitability.read');
    }
    ...
    public function view(User $user, mixed $resource): bool
    {
        ...
        return $this->allowsTenantResourceAction($user, 'profitability.read', $value);
    }

    public function manage(User $user): bool
    {
        return $this->allowsTenantAction($user, 'profitability.manage');
    }
}
